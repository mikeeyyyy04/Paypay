...
| `classes` | Sellable and enrollable class records. | `id`, `slug`, `title`, `category`, `description`, `instructor_name`, `schedule_label`, `capacity`, `enrolled`, `price_cents`, `currency`, `status`, `published_at`, timestamps | `id` | None | `slug unique`, positive capacity, valid enrolled count, nonnegative price | `status`, `published_at` |
